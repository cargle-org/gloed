    ...
    return (
        <>
                ...
                <div className=" jumbotron">
                    <div className="jumbotron-div1">
                        <h6 className=" text-1">
                            ...
                            <span>{siteText.jumbotronText1}</span>
                        </h6>
                        <h4 className="text-2">
                            {siteText.jumbotronText2part1} <span>{siteText.jumbotronText2part2}</span>  {siteText.jumbotronText2part3}
                        </h4>
                        <p className="text-3">
            ...
            <section id="available-courses" className="available-courses">
                <div className="">
                    <h2 className="pricing">{siteText.pricingHeader}</h2>
                    <h4 className="available-courses-text">{siteText.pricingText1}</h4>
                    <div className="pricing-div">
                        ...
                        {selectedCourse === "sql"
                            ...
                            <div className="coming-soon">
                                ...
                                <h4 className="">{siteText.excelText1}</h4>
                                <p className="">{siteText.excelText2}</p>
                ...
                <div className="join-our-slack-grid">
                    <div className="join-our-slack-grid-div1">
                        ...
                        <div className="join-our-slack-text">
                            <span className="">{siteText.joinOurCommunityText1}</span>
                            <h4 className="">{siteText.joinOurCommunityText2}</h4>
                            <p className="">
...
//                         <a href='tel:+2349066821545' className="contact-us-whatsapp">
                            <a href='https://bit.ly/gloedwhatsapp%22' className="contact-us-whatsapp">
                    ...
                    <div className="about-us-grid">
                        ...
                        <div className="about-us-grid-div2">
                            <div className="about-us-grid-text">
                                <span className="">{siteText.aboutUsText1}</span>
                                <h4 className="">{siteText.aboutUsText2}</h4>
                                <p className="">
