				...
				<div className=" jumbotron">
					<div className="jumbotron-div1">
						<h6 className=" text-1">
							...
							<span>AFFORDABLE, INTERACTIVE & FRIENDLY</span>
						</h6>
						<h4 className="text-2">
							We're <span>rethinking education  -</span>  to
						</h4>
						<p className="text-3">
							Meet you where you are & help you reach where you dream to be.
							<br />
							<strong>
								Learn how to communicate with databases using a
								standard management language.
							</strong>
						</p>
						<a href="##" className="join-slack">
						...
						{selectedCourse === "sql"
							? <div className="prices">
								<div className="price-plan-1">
									...
									<h6 className="plan-price">Free</h6>
								...
								<div className="price-plan-2">
									<p className="plan-name">INTERMEDIATE</p>
									<h6 className="plan-price">₦2,000</h6>
									<p className="plan-description">
								...
								<div className="price-plan-3">
									...
									<h6 className="plan-price">₦5,000</h6>
									<p className="plan-description">
							...
							<div className="coming-soon">
								...
								<p className="">Join our slack community to get up to date</p>
								<a href="##" className="join-slack">
									<div className="join-slack-button">
										<div className="join-slack-button-div1">
											JOIN SLACK COMMUNITY
				...
				<div className="join-our-slack-grid">
					<div className="join-our-slack-grid-div1">
						...
						<div className="join-our-slack-text">
							...
							<h4 className="">Slack Community</h4>
							<p className="">
								Join our slack community to collaborate with other people
								<br />
								<strong>and get answers to your SQL questions.  </strong>
							</p>
						</div>
						<a href="##" className="join-slack">
							<div className="join-slack-button">
					...
					<div className="about-us-grid">
						...
						<div className="about-us-grid-div2">
							<div className="about-us-grid-text">
								...
								<p className="">
									Our tutors have more than 10 years of experience teaching SQL and have trained 2,000 people from basic to advanced.
								</p>
							</div>
							<div className="people-trained">
								<div className="">
									<span className="main-text">10yrs</span>
									<span className="sub-text">Experience teaching people SQL</span>
								</div>
								<div className="">
									<span className="main-text">2,000</span>
									<span className="sub-text">Nuber of people trained</span>
								</div>
							</div>
							<a href="##" className="join-slack">
								<div className="join-slack-button">
					...
					<div className="footer-section1">
						<div className="logo-social">
							...
							<div className="socials">
								<img src={SocialSlack} alt="" className="" />
								<img src={SocialLinkedIn} alt="" className="" />
								<img src={SocialTwitter} alt="" className="" />
								<img src={SocialInstagram} alt="" className="" />
							</div>
						</div>
						<div className="footer-menu">
							...
							<ul className="footer-menu2">
								...
								<li className=""><a href="" className="">SQL Database</a></li>
								<li className=""><a href="" className="">MS Excell</a>.</li>
							</ul>
						</div>
					</div>
